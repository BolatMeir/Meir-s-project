...
let cities = ["Almaty", "Shymkent", "Taldygorgan", "Semey", "Pavlodar", "Astana" , "Kostanay", "Kokshetau", "Karaganda", "Petropavlovsk", "Uralsk", "Aktau", "Atyrau", "Kyzylorda", "Taraz"];
document.getElementById("kzcity").addEventListener("click", function(e) {
    e.preventDefault();
    cities.forEach(city => {
        Weather(city);
    })
...
function initSnow() { 
 ...
 marginBottom = document.body.scrollHeight + 1100; 
